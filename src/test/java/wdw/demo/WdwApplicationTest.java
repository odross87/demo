...
public class WdwApplicationTest {
    ...
    void CreateParksAndRides(){
        ...
        Attraction attraction2 = new Attraction(6L, "Kali River Rapids", "Skim across an erupting geyser, drift below a canopy of lush vegetation and be whisked along fast-moving rapids.");
        Attraction attraction3 = new Attraction(7L, "Big Thunder Mountain", "Race through a haunted gold mine aboard a speeding train on this thrilling coaster-style attraction.");
